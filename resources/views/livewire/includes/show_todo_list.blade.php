<div wire:key="{{ $toDo->id }}"
    ...
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex">
            ...
            @if ($edittingTodoId == $toDo->id)
            <div>
                <input wire:model="edittingTodoName" type="text" placeholder="Todo.." name="todoName"
                    class="mt-2 bg-gray-100  text-gray-900 text-sm rounded block w-full p-2.5">
                @error('edittingTodoName')
